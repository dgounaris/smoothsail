...
interface GithubApi {
  ...
  fun rebaseAndPush(repository: String, origin: String, target: String, newBranchName: String? = null): String // returns the hash of the branch
  fun pullCheckoutBranch(repository: String, branch: String): String // returns the hash of the branch
  fun mergeAndPush(repository: String, origin: String, target: String): String // returns the hash of the branch
}